"""
PDA (Photodiode Array Spectrophotometer) Analysis Module

This module provides functions for analyzing spectrophotometric data from photodiode 
...
Example
-------
>>> from enzykit.instruments.pda import process_pdc_timecourse, load_kinetic_data
>>> 
...
from .timecourse import process_pdc_timecourse
